...
namespace APIVerve.API.RemovePunctuation
{
    ...
    /// <summary>
    /// Client for the RemovePunctuation API
    /// </summary>
    public class RemovePunctuationAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/removepunctuation";
        ...
        public RemovePunctuationAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RemovePunctuationAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RemovePunctuationAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RemovePunctuationQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RemovePunctuationQueryOptions options)
        {
        ...
        public ResponseObj Execute(RemovePunctuationQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RemovePunctuationQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RemovePunctuationQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RemovePunctuationQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RemovePunctuationQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RemovePunctuationQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RemovePunctuationQueryOptions options)
        {
